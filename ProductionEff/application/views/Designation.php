   ...
   <div class="div2"> 
    ...
    &nbsp;&nbsp; <fieldset style= "border: 1px solid"> 
      ...
      <div class="table-responsive" id="dvContainer1"> 
        <div id="displayData">
          <legend><h5> Designation List </h5></legend> 
          <table border="2px" >
    ...
    <form  action="Save_Desg" method="POST" enctype="multipart/form-data">
      <br>
     <fieldset style= "border: 1px solid">
       <legend><h5> New Designation </h5></legend> 
        <span>&nbsp; Designation Id :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
        <input type="text" name="DesignationId" required readonly value="
          <?php
             //	$DesignationId=0;
    ...
    //          $results = $db_handle->runQuery($query);
        ...
        <input type="text" name="Designation" required placeholder="Designation Name" size="60" maxlength="100">
        </br></br>
