...
<?php $this->load->view('header.php');  ?>
   ...
   <div class="divm2"><a href="Gatepass"><img border="0" alt="Back" src="\Gatepass\Assets\Icon\Back.jpg" width="25" height="25" title="Back"></a></div>
    ...
    <div class="div1"> </div>
    <div class="div2">
    <form  action="Save_Gatepass" method="POST" enctype="multipart/form-data">

     <fieldset style= "border: 1px solid">
       <legend><h5> New Gatepass </h5></legend> 
        <center>
    ...
    //          $results = $db_handle->runQuery($query);
            ...
            <table align="center" >
                <tr>
                    <td> Gatepass No : </td>
                    <td><input type="text" name="Gatepassno" maxlength="10" required ></td>
                </tr>
                <tr>
                    <td> Date :</td>
                    <td><input type="date" name="Gatepassdate" required ></td>
                </tr>
            ...
            <td>  <select name="EmployeeCode" required onchange="showEmp(this.value)">
                    ...
                    //  require_once("DBController.php");
                      $db_handle = new DBController();
                          ...
                          $query = "SELECT * FROM Employee Where Companyid=".$_SESSION["sCompanyId"]." and active='"."Yes"."' order by EmployeeName";                  
              ...
              <span id="EmployeeCode"></span> 
                ...
                <tr><td><label for="">Shift:</label>
                <i class="fa-solid fa-business-time"></i></td>
                <td><select name="Shift" required >
                ...
                <tr>
                 <td> Vehicle : </td>
                 <td> <input type="text" name="Vehicle" maxlength="12" required > </td>
                </tr>
                <tr>
                 <td> Out time: </td>
                 <td><input type="text" id="OutHH" name="OutHH" title ="Enter in 24 Hour format" required placeholder="HH" size="2" maxlength="2" min="0" max="24" onchange="calctottime(this.value)">
                      <input type="text" id="OutMM" name="OutMM" title="Enter Minutes" required placeholder="MM" size="2" maxlength="2" min="0" max="60" onchange="calctottime(this.value)">
                    </td>
                </tr>                
                <tr>
                 <td> In Time : </td>
                 <td> <input type="text" id="InHH" name="InHH" title ="Enter in 24 Hour format" required placeholder="HH" size="2" maxlength="2" min="0" max="24" onchange="calctottime(this.value)">
                      <input type="text" id="InMM" name="InMM" title="Enter Minutes" required placeholder="MM" size="2" maxlength="2" min="0" max="60"
                      onchange="calctottime(this.value)">
                   </td>
                 </tr>
                <tr>
                 <td> Total Time : </td>
                ...
                <tr>
                  ...
                  <td> <input type="text" name="Leavereason" maxlength="100" size="40" required ></td>
                </tr>

                <tr>
                  <td>Location Where Going : &nbsp;</td>
                  <td><input type="text" name="Location" maxlength="100" size="40" required ></td>
                </tr>
                <tr>
                  <td>KM Travelled : &nbsp;</td>
                  <td><input type="text" name="Kilometer" title ="Enter KM Travelled" required placeholder="KM Travelled" size="4" maxlength="4" min="0" max="9999" value="0"></td>
                </tr>   
            </table>
        ...
        <center> <input type="Reset" value="Reset"> <input type="Submit" value="Save"> </center>     
