	  ...
	  if ($_POST['Submit']='Submit')
       {
          ...
          $sCompanyId=$_SESSION["sCompanyId"];
             ...
             $sql = 'INSERT INTO SiteMaster (SiteId, SiteName, CompanyId)
             VALUES (:SiteId, :SiteName, :CompanyId)';
...
public function Save_Dept_model()
{
    if ($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        $sql = 'INSERT INTO DeptMaster (DepartmentName, SiteId, CompanyId)
                VALUES (:DepartmentName, :SiteId, :CompanyId)';
